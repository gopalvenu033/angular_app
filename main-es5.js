...
var AccoutnumPipe = /** @class */ (function () {
    function AccoutnumPipe() {
    }
    AccoutnumPipe.prototype.transform = function (input) {
        var output = '';
        if (!input)
            return null;
...
var AjaxComponent = /** @class */ (function () {
    function AjaxComponent(httpClientObj) {
    ...
    AjaxComponent.prototype.getData = function () {
        var _this = this;
        this.dataLoading = true;
        var url = 'https://jsonplaceholder.typicode.com/comments';
        // let url="assets/data/comments.json"
        this.httpClientObj.get(url).subscribe(function (res) {
            _this.dataLoading = false;
            _this.allComments = res;
        }, function (error) { console.log(error); });
    };
    AjaxComponent.ctorParameters = function () { return [
...
var Chil1Component = /** @class */ (function () {
    function Chil1Component() {
        this.a = 45;
        this.b = 67;
    ...
    Chil1Component.prototype.ngOnInit = function () {
    };
    Chil1Component.prototype.addData = function () {
...
var Chil2Component = /** @class */ (function () {
    function Chil2Component() {
        this.c = 34;
        this.d = 78;
    }
    Chil2Component.prototype.ngOnInit = function () {
    };
...
var Child1Component = /** @class */ (function () {
    ...
    Child1Component.prototype.ngOnChanges = function (obj) {
        console.log("I am child onchange");
        console.log(obj);
    };
    Child1Component.prototype.sendData = function () {
...
var Child2Component = /** @class */ (function () {
    ...
    function Child2Component(cdRef) {
        this.cdRef = cdRef;
    ...
    Child2Component.prototype.sendData = function () {
        this.arrEvent.emit(this.arr);
    };
    Child2Component.prototype.ngDoCheck = function () {
        //this.cdRef.markForCheck();
    };
    Child2Component.ctorParameters = function () { return [
...
var CreditcardPipe = /** @class */ (function () {
    function CreditcardPipe() {
    }
    CreditcardPipe.prototype.transform = function (input) {
        var output = "";
...
var CrudComponent = /** @class */ (function () {
    function CrudComponent(employeeServiceObj) {
        this.employeeServiceObj = employeeServiceObj;
        this.employee = [];
    }
    CrudComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.employeeServiceObj.getAllEmployees().subscribe(function (res) {
            _this.allEmployees = res;
            console.log(_this.allEmployees);
        });
    };
    CrudComponent.prototype.deleteEmployee = function (id) {
        console.log(id);
        this.employeeServiceObj.deleteEmployee(id).subscribe(function (res) { return console.log("successfull"); });
    };
    CrudComponent.prototype.addEmployee = function (id, f_name, l_name, email) {
        var employeedata = { id: id, first_name: f_name,
            last_name: l_name, email: email };
        this.employeeServiceObj.addNewEmployee(employeedata).subscribe(function (res) { console.log("successfull"); });
        id = "";
    };
    CrudComponent.prototype.getEmployeeById = function (eId) {
        var _this = this;
        this.employeeServiceObj.getEmployeeById(eId).subscribe(function (res) {
            _this.employee.push(res);
            //console.log(this.employee);
        });
    };
    CrudComponent.prototype.UpdateEmployee = function (id, f_name, l_name, email) {
        var employeedata = { id: id, first_name: f_name,
            last_name: l_name, email: email };
        this.employeeServiceObj.updateEmployee(employeedata).subscribe(function (res) { console.log("successfull"); });
        //id="";
    };
...
var DatabindingComponent = /** @class */ (function () {
    ...
    DatabindingComponent.prototype.f1 = function () {
        alert('This is f1 method');
    };
    //or
    //a:number=10;
    //b:number=20;
    DatabindingComponent.prototype.add = function (a, b) {
        a = parseInt(a);
        b = parseInt(b);
        alert(a + b);
    };
...
var DirectiveComponent = /** @class */ (function () {
    ...
    //flag=true;
    DirectiveComponent.prototype.toggle = function () {
        this.flag = !this.flag;
    };
    DirectiveComponent.prototype.myStyleFunction = function () {
        return this.myStyles;
    };
    DirectiveComponent.prototype.myClassFunction = function () {
...
var EmployeeService = /** @class */ (function () {
    function EmployeeService(httpClientObj) {
        this.httpClientObj = httpClientObj;
        this.wikiList = [];
    ...
    EmployeeService.prototype.deleteEmployee = function (eId) {
...
var InitialPipe = /** @class */ (function () {
    ...
    InitialPipe.prototype.transform = function (input, gender) {
        var output = '';
        if (gender == 'male') {
            output = 'Mr.' + input;
        }
...
var JavascriptComponent = /** @class */ (function () {
    function JavascriptComponent(router) {
        this.router = router;
    }
    JavascriptComponent.prototype.ngOnInit = function () {
    };
    JavascriptComponent.prototype.gotoHtml = function () {
        this.router.navigate(['/html']);
    };
    JavascriptComponent.ctorParameters = function () { return [
...
var MathService = /** @class */ (function () {
    ...
    MathService.prototype.sub = function (a, b) {
        return a - b;
    };
...
var ModeldrivenformComponent = /** @class */ (function () {
    function ModeldrivenformComponent(formBuilder) {
    ...
    ModeldrivenformComponent.ctorParameters = function () { return [
...
var MysortPipe = /** @class */ (function () {
    function MysortPipe() {
    }
    MysortPipe.prototype.transform = function (input) {
...
var ObservableComponent = /** @class */ (function () {
    function ObservableComponent() {
        ...
        this.subscriber8 = this.publisher8.subscribe(function (val) {
            document.writeln(val + "");
        });
        this.x = setTimeout(function () {
            _this.subscriber8.unsubscribe();
        }, 5000);
    }
...
var OrdinalPipe = /** @class */ (function () {
    ...
    OrdinalPipe.prototype.transform = function (num1) {
        var num = num1 % 10;
        var num2 = '';
        if (!num1) {
            num2 = "";
...
var Paren1Component = /** @class */ (function () {
    function Paren1Component() {
        this.x = 10;
        this.y = 20;
    }
    Paren1Component.prototype.ngOnInit = function () {
    };
    Paren1Component.prototype.getA = function (data) {
        this.aValue = data;
    };
    Paren1Component.prototype.getB = function (data) {
        this.bValue = data;
    };
...
var ParentComponent = /** @class */ (function () {
    ...
    ParentComponent.prototype.getA = function (data) {
        this.aChild = data;
    };
    ParentComponent.prototype.getB = function (data) {
        this.bChild = data;
    };
    ParentComponent.prototype.getArr = function (data) {
        this.arrChild = data;
    };
    ParentComponent.prototype.addCar = function (newCar) {
...
var PipeComponent = /** @class */ (function () {
    ...
    PipeComponent.prototype.add = function () {
...
/* harmony import */ var node_modules_angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! node_modules/@angular/material/snack-bar */ "./node_modules/@angular/material/esm5/snack-bar.es5.js");
...
var ProductsComponent = /** @class */ (function () {
    function ProductsComponent(ProductServiceObj, _snackBar) {
    ...
    ProductsComponent.prototype.openSnackBar = function (message, action) {
        this._snackBar.open(message, action, {
            duration: 2000,
        });
    };
    ProductsComponent.prototype.sweetalert = function () {
...
var RemainingPipe = /** @class */ (function () {
    function RemainingPipe() {
    }
    RemainingPipe.prototype.transform = function (input, arg) {
        var output;
...
var SearchPipe = /** @class */ (function () {
    ...
    SearchPipe.prototype.transform = function (input, arg) {
        if (!input)
            return null;
        if (!arg)
            return input;
...
var ServiceComponent = /** @class */ (function () {
    function ServiceComponent(MathServiceObj) {
    ...
    ServiceComponent.prototype.addition = function (a, b) {
        a = parseInt(a);
        b = parseInt(b);
...
var TemplateformComponent = /** @class */ (function () {
    ...
    TemplateformComponent.prototype.submitForm = function (formData) {
        this.submitted = true;
